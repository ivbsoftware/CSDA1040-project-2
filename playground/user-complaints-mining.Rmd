...
## Define topics of first 3 'test' complaints
...
for (issueName in most_freq_issues_list) {
  print(issueName)
  compNarr <- subset(train, Issue == issueName)$`Consumer complaint narrative`
}

df[df$Issue %in% most_freq_issues_list,]$Issue
