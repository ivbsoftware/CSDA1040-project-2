...
and removing stop words. The general English stop-word list is tailored by adding "available" and "via".

```{r}
myCorpus <- Corpus(VectorSource(df$`Consumer complaint narrative`))
